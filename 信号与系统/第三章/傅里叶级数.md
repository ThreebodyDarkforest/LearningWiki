...
不妨假设 $f(t)$ 为周期信号（三角函数是周期的，所以 $f(t)$ 也应该是周期的），周期为 $T$，角频率 $\omega_0$，那么因为
...
（2）每条谱线的间距为 $\Omega = \dfrac{2\pi}{T}(\omega)$ 或 $\dfrac{1}{T}(f)$，称为谱线间隔，注意单位是频率单位。
...
* 波形的对称性有两类，一类是对整周期对称，如奇函数和偶函数，还有一类是半周期对称，如奇谐函数。

#### 偶函数

当 $f(t)$ 为偶函数，$f(t)\sin(n\omega_0t)$ 为奇函数，$f(t)\cos(n\omega_0)t$ 为偶函数，则

$$
a_n = \dfrac{4}{T}\int_0^{\frac{T}{2}}f(t)\cos(n\omega_0t)dt
$$
...
$$
F_n = F_{-n} = \dfrac{a_n}{2}
$$

即偶函数的 $F_n$ 为实数，在偶函数的傅里叶级数中不含正弦项，只可能含有余弦项和直流项。

#### 奇函数

当 $f(t)$ 为奇函数，$f(t)\sin(n\omega_0t)$ 为偶函数，$f(t)\cos(n\omega_0)t$ 为奇函数，则
...
$$
b_n = \dfrac{4}{T}\int_0^{\frac{T}{2}}f(t)\sin(n\omega_0t)dt
$$
...
所以奇函数的 $F_n$ 为虚数，在奇函数的傅里叶级数中不含余弦项，只可能包含正弦项和直流项。

#### 奇谐函数

若波形沿时间轴平移半个周期并相对于该轴上下翻转，此时波形不变化，即满足

$$
f(t) = -f(t \pm \dfrac{T}{2})
$$
...
\begin{aligned}
    &a_0 = 0,\\
    &a_n = b_n = 0, &n 为偶数\\
    &a_n = \dfrac{4}{T}\int_{0}^\frac{T}{2}f(t)\cos(n\omega_0t)dt, &n 为奇数\\
    &b_n = \dfrac{4}{T}\int_{0}^\frac{T}{2}f(t)\sin(n\omega_0t)dt, &n 为奇数
\end{aligned}
\right\}
$$
...
$$
a_n = \dfrac{E\tau\omega_0}{\pi}Sa(\dfrac{n\omega_0\tau}{2})
$$
...
$$
F_n = \dfrac{E\tau}{T}Sa(\dfrac{n\omega_0\tau}{2})
$$

是一个抽样函数。

![Screenshot-from-2022-11-03-04-58-3538e554695f958878.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-04-58-3538e554695f958878.png)

> 注：
> （1）抽样函数 $Sa(t) = \dfrac{\sin t}{t}$，在 $k\pi, k = 1, 2, 3\cdots$ 取 $0$。
> （2）通常把 $\dfrac{2\pi}{\tau}(\omega)$ 或 $\dfrac{1}{\tau}(f)$ 称作周期矩形信号的**带宽**，它是抽样函数第一个零点到原点的距离。带宽内的信号一般占总能量的 $90\%$ 以上，传输这部分即可保留原信号绝大多数信息。
> （3）当 $n = 0$ 时，$|F_0| = \dfrac{E\tau}{T}$。
> （4）直流分量、基波及各谐波分量大小正比于脉幅 $E$ 和脉宽 $\tau$，反比于周期 $T$。

#### 周期锯齿波信号

![Screenshot-from-2022-11-03-05-04-06.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-04-06.png)

#### 周期半波余弦信号

![Screenshot-from-2022-11-03-05-04-13.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-04-13.png)
...
![Screenshot-from-2022-11-03-05-05-43.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-05-43.png)

### 二

* 画频谱

![Screenshot-from-2022-11-03-05-06-04.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-06-04.png)
![Screenshot-from-2022-11-03-05-06-09.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-06-09.png)
![Screenshot-from-2022-11-03-05-06-16.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-06-16.png)
![Screenshot-from-2022-11-03-05-06-22.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-06-22.png)

### 三

* 求频谱

![Screenshot-from-2022-11-03-05-06-32.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-06-32.png)

### 四

* 周期信号的功率计算

![Screenshot-from-2022-11-03-05-07-02.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-07-02.png)
![Screenshot-from-2022-11-03-05-07-08.png](http://image.tjzfile.xyz/images/2022/11/02/Screenshot-from-2022-11-03-05-07-08.png)